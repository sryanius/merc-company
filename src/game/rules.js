 ...
 *
 * ★ §173 잠정 변환값. 곡선이 500심층 앵커로 바뀌고 소탕(매주 «기록+1» 부터 만피)이 생겨 같은 전력으로
 *   더 깊이 간다. 옛 실측(전력 → 이월 잠수 최대)을 «×1.3 (만피 단판 벽 / 이월 벽 · 실측 1.2~1.37) →
 *   옛 배율 → 새 심층» 으로 옮겼다. 영웅(§175)까지 넣은 뒤 격자로 다시 잰다.
 *   옛 표: [5k,18] [10k,29] [20k,51] [30k,66] [50k,86] [75k,108] [100k,128] [190,470,163]
 */
