...
export const ROSTER_CAP_COST = {
  ...
  /* §191 70 → 150 (제작자 요청). **같은 ×1.35 곡선을 그대로 이었다** — 새 구간만 다른 기울기를
   *   쓰면 어디서 벽이 서는지 사람이 예측할 수 없다.
   *   70 → 150 소계 **1억 1,451만 G** (20 → 150 전체 1억 1,538만 G).
   *   ★ 이 구간에서는 정원보다 **비용**이 벽이다 — 인건비는 아니다: 150명 Lv80 S 4차가
   *     주 174,482G 인데, 500심층 소탕 수입(주 180만 G)의 9.6% 밖에 안 된다 (§186 뒤 실측).
   *     그래서 «돈을 모아 정원을 넓힌다» 가 이 구간의 목표가 된다. */
  75: 332000, 80: 448000, 85: 605000, 90: 817000, 95: 1100000, 100: 1490000,
  105: 2010000, 110: 2710000, 115: 3660000, 120: 4950000, 125: 6680000, 130: 9010000,
  135: 12200000, 140: 16400000, 145: 22200000, 150: 29900000,
};
