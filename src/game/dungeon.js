 ...
 *     그래서 1~9웨이브는 완만하고(2.68 → 3.30, 총 x1.23) **10웨이브만 벽(5.36)** 이다.
 *
 ...
 *
 * 기준선: **전설 10칸을 낀 Lv80 4차 grade B 부대**다. 예전 표(1.48 시작)는 장비 없는 부대
 *   기준이었는데, 10슬롯 확장으로 실제 만렙 부대가 1.83배 세져 그 잣대가 통째로 무의미해졌다.
 ...
 *  1~9웨이브는 완만(2.68 → 3.30), **10웨이브만 벽(5.36)** — 위 (3)·(3-b) 참조.
 *  ★ 10웨이브는 매우 가파르다(실측 5.33 → 40% / 5.36 → 30% / 5.45 → 8%). 0.01 단위로 만져라. */
export const WAVE_POWER = [2.68, 2.70, 2.72, 2.74, 2.76, 2.80, 2.90, 3.05, 3.30, 5.36];
