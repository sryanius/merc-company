...
export const GRADE_COLOR = {
  ...
  /* §182 영웅 = 자홍 (#ff7fd8) — A(#e0913a 호박)와 주황이 겹쳤다. 각성석(#ff7fd8)과 같은 분홍 — «분홍 돌 모아 → 분홍 영웅». 예전(§180.4 주황). 상아(§179)·금(§180.2)은 「눈에 잘 안 띈다」 — 제작자. 테두리는 css 의 주황 그라데이션이 맡는다. A(#e0913a 호박)보다 붉고 밝다. */
  H: '#ff7fd8',
};
