...
export const LINEAGE_TRAIT = {
  ...
  shieldman: {
    ...
    guardChance: 0.22,   // 아군이 맞을 때 대신 맞을 확률 (실측 0.30 은 과했다)
  ...
  swordsman: {
    ...
    riposte: 0.35,       // 받은 피해의 이만큼을 되돌려준다 (근접 피격에 한함)
  },
  ...
  spearman: {
    ...
    intercept: 0.15,     // 파고드는 적 근접을 자기가 대신 받는 확률
  },
  ...
  archer: {
    ...
    chargeSlow: 0.10,    // 적 근접의 돌진 시간이 이만큼 늘어난다
  },
  ...
  apprentice: {
    ...
    wardShield: 0.18,    // 최대 HP 의 이만큼을 방패로 들고 시작
  },
...
export const BRANCH_TRAIT = {
  ...
  monk: {
    ...
    dmgCutAura: 0.12,    // 진영 전체 피해 감소 (겹치면 합산 후 상한)
  },
};
