...
export const LINEAGE_TRAIT = {
  ...
  spearman: {
    ...
    /* ★★ **대신 받는 게 아니라 쳐낸다** — 맞는 횟수를 늘리면 느리면 오히려
     *   손해라는 걸 네 번 재고 알았다 (−2.5 → +1.2 → −3.4).
     *   그래서 지금은 **아예 한 번을 지운다.** 대신 확률이 낮다. */
    intercept: 0.18,          // 뒷줄을 노린 위험한 한 방을 쳐낼 확률
    interceptCounter: 0.60,   // 쳐낸 뒤 되받아치는 양 (막은 피해 대비)
  },
