 ...
 *
 * ─────────────────────────────────────────────────────────────────────────
 * ★ 실측 결과 (2026-09-09 · `--grid=3` · 806구성/합법 539 · 617s · 세트 2·3단과 각성 영웅을 축에 넣은 첫 격자)
 *
 ...
 *     |       5,000 |       20 | Lv1 F 맨몸                     |
 *     |      10,000 |       36 | Lv3 A 맨몸                     |
 *     |      20,000 |       55 | Lv1 S ilvl1                    |
 *     |    ★27,127 |       71 | Lv15 A ilvl1                   |
 *     |      30,000 |       71 | Lv5 S ilvl10                   |
 *     |      50,000 |       92 | Lv35 A ilvl10                  |
 *     |      75,000 |      150 | Lv40 S ilvl25                  |
 *     |     100,000 |      240 | Lv30 S **2단**ilvl=Lv          |
 *     |     150,000 |      349 | Lv50 **영웅** 2단ilvl=Lv        |
 *     |     190,470 |      408 | Lv60 영웅 2단ilvl=Lv            |
 *     |     250,000 |      500 | Lv100 영웅 2단ilvl=Lv (바닥)     |
 *
 *   심층별 최소 필요 전력: 96 = 50,514 · 200 = 90,545 · 300 = 141,443 · 400 = 169,558 · 500 = 235,125
 *
 *   ⇒ **96심층 최소 필요 전력 = 50,514** (Lv70 D ilvl1). 옛 격자(상한 130·1단만)는 57,122 였다 —
 *      2·3단 세트가 더 싼 길을 열었다. 표는 그만큼 **너그러워졌다**(오탐이 줄었다).
 *   ⇒ **전력 27,127 의 심층 상한 = 71.** 그 치트가 신고한 96 은 필요 전력의 54% 다.
 *   ⇒ 400 위는 **각성 영웅이 있어야** 열린다(§178 관문) — 400+ 포락선은 전부 영웅 편성이다.
 *      영웅 없는 최고는 Lv80 S 3단 = 400 에서 정확히 멈춘다.
 *
